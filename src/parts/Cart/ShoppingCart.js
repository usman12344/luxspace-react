    ...
    <div className="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
            ...
            <p id="cart-empty" className="hidden text-center py-8">
              ...
              <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                <div className="px-4 flex-none">
                  <div className="" style={{ width: 90, height: 90 }}>
                    <img src="/images/content/chair-room1.jpg" alt="chair office room 1" className="object-cover rounded-xl w-full h-full" />
                  </div>
                </div>
                ...
                <div className="px-4 w-auto md:w-5/12 flex-none hidden md:block">
                  <div className="">
              ...
              <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="2">
                <div className="px-4 flex-none">
                  <div className="" style={{ width: 90, height: 90 }}>
                    <img src="/images/content/chair-room2.jpg" alt="chair office room 2" className="object-cover rounded-xl w-full h-full" />
                  </div>
                </div>
                <div className="px-4 w-auto md:w-5/12 flex-1">
                  <div className="">
              ...
              <div className="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="3">
                <div className="px-4 flex-none">
                  <div className="" style={{ width: 90, height: 90 }}>
                    <img src="/images/content/chair-room3.jpg" alt="chair office room 3" className="object-cover rounded-xl w-full h-full" />
                  </div>
                </div>
                <div className="px-4 w-auto md:w-5/12 flex-1">
                  <div className="">

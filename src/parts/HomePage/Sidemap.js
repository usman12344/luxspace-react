    ...
    <section className="sitemap">
      <div className="border-b border-gray-200 py-12 mt-16 px-4">
        <div className="flex justify-center mb-8">
            <img src="/images/content/logo.svg" alt="Luxspace- adalah sebuah website yang menjual barang-barang furniture" />
        </div>
        <aside className="container mx-auto">
          <div className="flex flex-wrap md:space-x-4 justify-center">
        <SitemapLinks setActive={setActive} isActive = {active === 1 ? null : 1} title="Company">
        <li><Link to="/shipping" className="hover:underline py-1 block">Shipping</Link></li>
                <li><Link to="/refund" className="hover:underline py-1 block">Refund</Link></li>
                <li><Link to="/promotion" className="hover:underline py-1 block">Promotion</Link></li> 
        </SitemapLinks>
            



          <SitemapLinks setActive={setActive} isActive = {active === 2 ? null : 2} title="Explore">
              <li><Link to="/about" className="hover:underline py-1 block">About</Link></li>
              <li><Link to="/career" className="hover:underline py-1 block">Career</Link></li>
              <li><Link to="/contact-us" className="hover:underline py-1 block">Contact Us </Link></li>
            </SitemapLinks>
        



        <SitemapLinks setActive={setActive} isActive = {active === 3 ? null : 3} title="Overview">
            <li><Link to="/terms&conds" className="hover:underline py-1 block">Terms & Conds</Link></li>
            <li><Link to="/privacy-poilicy" className="hover:underline py-1 block">Privacy Policy</Link></li>
            <li><Link to="/for-developer" className="hover:underline py-1 block">For Developer </Link></li>
            </SitemapLinks>

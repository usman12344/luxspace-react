        ...
        <div className="flex flex-strech items-center">
          ...
          <div className="w-auto">
            <ul className="flex items-center">
              ...
              <li className="ml-6">
                <Link  to="/cart" className={theme === "white" ? "flex items-center justify-center w-8 h-8 text-white hover:text-black cart cart-filled" : "flex items-center justify-center w-8 h-8 text-black hover:text-black cart cart-filled"} >

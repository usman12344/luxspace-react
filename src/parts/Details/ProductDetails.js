    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
        ...
        <div className="flex-1">
          <div className="slider">
            <div className="thumbnail">
              ...
              <div className="px-2">
                <div className="item selected" data-img="./images/content/chair.jpg">
                  <img src="/images/content/chair.jpg" alt="chair side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              ...
              <div className="px-2">
                <div className="item" data-img="./images/content/chair2.jpg">
                  <img src="/images/content/chair2.jpg" alt="chair side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
               ...
               <div className="px-2">
                <div className="item" data-img="./images/content/chair3.jpg">
                  <img src="/images/content/chair3.jpg" alt="chair side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
               ...
               <div className="px-2">
                <div className="item" data-img="./images/content/chair4.jpg">
                  <img src="/images/content/chair4.jpg" alt="chair side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
               ...
               <div className="px-2">
                <div className="item" data-img="./images/content/chair5.jpg">
                  <img src="/images/content/chair5.jpg" alt="chair side" className="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
            ...
            <div className="preview">
              <div className="item rounded-lg h-full overflow-hidden">
                <img src="/images/content/chair.jpg" alt="" className="object-cover w-full h-full rounded-lg" />
              </div>
            </div>
          </div>
        </div>
        <div className="flex-1 px4 md:p-6">
          ...
          <Link to="/cart/:idc" className="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex md:w-auto w-full justify-center">
